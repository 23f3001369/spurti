...
const THEME_NAMES = {
  light: 'Light',
  dark: 'Dark · slate blue',
  'dark-black': 'Dark · true black',
  'dark-neutral': 'Dark · neutral gray',
  'dark-navy': 'Dark · deep navy',
  'dark-warm': 'Dark · warm brown',
  'dark-ebony': 'Dark · ebony',
  'dark-charcoal': 'Dark · charcoal',
  'dark-graphite': 'Dark · graphite',
  'dark-midgray': 'Dark · mid gray'
};
const THEME_ORDER = ['light', 'dark', 'dark-black', 'dark-neutral', 'dark-navy', 'dark-warm', 'dark-ebony', 'dark-charcoal', 'dark-graphite', 'dark-midgray'];

function applyTheme(theme) {
  document.documentElement.setAttribute('data-theme', theme);
  localStorage.setItem('spurti-theme', theme);
}

function ThemeToggle() {
  const [theme, setTheme] = useState(() => {
    const saved = localStorage.getItem('spurti-theme');
  ...
  return (
    <button className="theme-toggle" onClick={cycle} aria-label={isDark ? 'Switch to light mode' : 'Switch to dark mode'} title={`Theme: ${THEME_NAMES[theme]}. Click to switch.`}>
      {isDark ? (
