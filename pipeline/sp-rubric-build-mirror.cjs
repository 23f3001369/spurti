...
// peer-review FAQ awards; 'streak' = daily-streak SP (web-app driven, not in the
// Zoom mirrors); 'peer_review' = peer-review rubric awards. We fold their deltas
// back into each student's balance.
